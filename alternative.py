# -*- coding: utf-8 -*-
"""
Created on Fri Jan  6 15:39:55 2023
...
CONSUMER_KEY="Km6abOPbJLOa7wllDz78AJnaX"
CONSUMER_SECRET= "EiexvYRWLqB9yQW4LRrJT1aSawUhOTdAZ3hdwZmTwCw8oqgoc6"
ACCESS_KEY="1594972756185337856-m2TWFlLCikYCcjW4gWIh6hv5upWKsM"
ACCESS_SECRET="DEZAJBWAEOD1CoWE3Hwe2VRPO2LBpCchu1ENisl2IByVl"
...
os.environ['STABILITY_KEY'] = 'sk-ysJenYrILQpoSfWrwfxtRRfhmSXCPYGlV64IyVnVuqvHIQvc'
...
def gptgen(prompt):
    ...
    try:
        ...
        print("Error occurred when calling OpenAI API:", e)
        return None
...
def tweeter(hashtag):
    while True:
        try:
            ...
            cmdForPmptTxt="write a short tweet about this summary: "+ summary
            ...
            #posting the image and the tweet
            api.update_status_with_media(tweet,name+".png", in_reply_to_status_id=None, exclude_reply_user_ids=None, attachment_url=None, media_ids=None, possibly_sensitive=False, lat=None, long=None, place_id=None, display_coordinates=False)
            print(tweet)
            print ("just posted")
            print(prompt)
            # img.show()
